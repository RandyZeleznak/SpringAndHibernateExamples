...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create objects 
			Instructor instructor = new Instructor("Steve", "Howe" , "steve@yes.com");
			InstructorDetail instructorDetail = new InstructorDetail("http://www.youtube.com/yessongs", "Playing Awsome Acoustic Guitar");
